...
public record CreateCustomArticleRequest(
        ...
        @Size(max = ArticleLimits.TITLE, message = "文章标题不能超过 500 个字符")
        String title,

        @Size(max = ArticleLimits.SUMMARY, message = "文章摘要不能超过 2000 个字符")
        String summary,

        @NotBlank(message = "正文内容不能为空")
        @Size(max = ArticleLimits.MARKDOWN, message = "正文内容不能超过 100000 个字符")
        String markdown,
        ...
        @Size(max = ArticleLimits.MARKDOWN, message = "英文正文不能超过 100000 个字符")
        String markdownEn,
